        ...
        <Box pad={"large"} flex={"grow"} gap={"medium"}>
          <Link to={"synthetic-media"}>
            <Box pad={"large"} border hoverIndicator={true}>
              ...
              <Text>
                Is deep fake technology even capable of being used for a good
                purpose? Since the genie is out of the bottle now, how do we
                make sense of the forthcoming chaos it brings.
              </Text>
            </Box>
          </Link>

          <Box pad={"large"} border>
            <Link to={"aryan-invasion-theory"}>
              <Heading level={2}>Aryan Invasion Theory</Heading>
            </Link>
          </Box>

          <Box pad={"large"} border>
            <Link to={"internet-shutdown"}>
