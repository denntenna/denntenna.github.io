...
<Box align="center" margin={{ bottom: "medium" }}>
  <iframe
    src="https://www.instagram.com/p/CkJNinHDiV3/embed/"
    width="400"
    height="480"
    frameBorder="0"
    scrolling="no"
...
### 6. Playing with Samples

Sample credits go to [Emma Chamberlain](https://www.youtube.com/watch?v=F14Flnq3zCY)
...
`}
  ...
  <Box width={"xsmall"} pad={"small"} alignSelf={"center"}>
    <iframe
      width="289"
      height="157"
      src="https://www.youtube.com/embed/JQTiSzQP_Fg"
      title="denntenna"
      frameborder="0"
      allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
      allowfullscreen
