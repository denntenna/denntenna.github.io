...
Thankfully it was a `.parcel-cache` that snuck into the image. Adding it to .gitignore brought down the image size from 4 GB to 814 MB. This big drop made me write this.
